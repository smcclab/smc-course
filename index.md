...
**LENS is running in Semester 1, 2020** as a course in computer music making and
 ...
 elsewhere around the ANU. Check out the info below (including the [FAQ](#faq))
 and get in touch with with [Ben Swift](mailto:ben.swift@anu.edu.au), [Alec
...
design** through a series of workshops. You'll put these skills to use creating
a **computer musical instrument**, **composition**, or **interactive media
...
- make & submit a musical response (via a short video) which explores that
  concept (_in your own time_)
