...
If you put your slides in the top-level `_assets/` folder then you can use a
link like this (although you can use whatever directory structure you like):

- [Week 1 slides]({{site.baseurl}}{% link _assets/lectures/compXXXX-week-1.pdf %})
...
- [slides]({{site.baseurl}}{% link _assets/lectures/compXXXX-week-1.pdf %})
- [video](http://broken-link)
- [audio](http://broken-link)
