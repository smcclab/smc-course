...
id="vision"
image="lectures/genai/rohan-performance-2-performance.JPG"
bgcol="#000000"
opacity="0.5" 
heading="vision"
%}
...
{% include slides/background-image.html
id="why"
image="lectures/genai/2015-11-28-Electrofringe-Workshop-2.jpg"
bgcol="#000000"
opacity="0.5" 
heading="why?"
%}
...
image="lectures/genai/musical-performance-predictions.jpg"
bgcol="#000000"
opacity="0.5" 
...
image="lectures/genai/don-banks-ANU.jpg"
...
{% include slides/background-image.html
id="voyager"
image="lectures/genai/GeorgeLewis-1999-credit-IanCummings.jpg"
...
{% include slides/background-image.html
id="continuator"
image="lectures/genai/continuator-francoispachet.jpg"
...
{% include slides/background-image.html
id="wekinator"
image="lectures/genai/rebecca-fiebrink-wekinator.jpg"
...
{% include slides/background-image.html
id="magenta"
image="lectures/genai/magenta-demos.jpg"
bgcol="#FFFFFF"
opacity=0.9
bgsize="contain"
...
{% include slides/background-image.html
id="venn-diagram"
image="lectures/genai/charlesmartin-background.jpg"
bgcol="#FFFFFF"
bgsize="contain"
%}
...
![]({% link assets/lectures/genai/imps-nimes-examples.jpg %})
...
![]({% link assets/lectures/genai/sequence-learning.png %})


## Interacting with predictions

![]({% link assets/lectures/genai/predictive-interaction-motivation.png %})
...
![Physical Intelligent Instrument]({% link assets/lectures/genai/physical-intelligent-instrument2.png %}){:style="width:35%"}
...
id="rpiinsttitle" 
video="lectures/genai/physical-intelligent-instrument.mp4" 
loop="true"
background="#000000"
opacity="0.7"
...
video="lectures/genai/neural-ensemble-interaction.mp4" 
loop="true"
background="#000000"
opacity="0.7"
heading="GestureRNN"
...
![Gesture RNN]({% link assets/lectures/genai/gesture-rnn.png %}){:style="width:80%"}
...
{% include slides/background-video.html 
id="robojamtitle" 
video="lectures/genai/robojam-drum-response.mp4" 
loop="true"
background="#000000"
opacity="0.7"
heading="RoboJam"
...
image="lectures/genai/MetatoneClassifier-SystemDiagram.jpg"
%}
...
![Robojam Interaction]({% link assets/lectures/genai/robojam-interaction.png %}){:style="width:45%"}
...
![]({% link assets/lectures/genai/mdn-motivation.png %})


{% include slides/background-video.html 
id="robojamperf" 
video="lectures/genai/robojam-one-loop.mp4" 
loop="true"
background="#000000"
%}
...
{% include slides/background-video.html 
id="imps-title" 
video="lectures/genai/imps-lightpad-loop.mp4" 
loop="true"
background="#000000"
opacity="0.7"
muted="true"
...
![]({% link assets/lectures/genai/IMPS_connection_example.png %}){:style="width:80%;"}
...
{% include slides/background-video.html
id="impsxtouch"
video="lectures/genai/imps-xtouch-loop.mp4"
%}


{% include slides/background-video.html
id="impsglissrnn"
video="lectures/genai/glissrnn.mp4"
%}
...
![Test computers]({% link assets/lectures/genai/imps-test-computers.jpg %})


## Results: Time per prediction {#imps-timeperpredunits}

![Time per prediction vs LSTM units]({% link assets/lectures/genai/prediction_time_against_units.png %})
...
![Time per prediction vs MDN dimension]({% link assets/lectures/genai/prediction_time_against_dimension_64units.png %})
...
![]({% link assets/lectures/genai/training_loss_12K_lightpad_model.png %})
...
![]({% link assets/lectures/genai/training_loss_100K_lightpad_model.png %})
...
![]({% link assets/lectures/genai/robojam_temperature_sampling_0.png %}){:style="width:45%"}
...
{% include slides/background-video.html
id="empititle"
video="lectures/genai/empi-micro-demo.mp4"
loop="true"
opacity="0.7"
muted="true"
background="#000000"
...
![]({% link assets/lectures/genai/EMPI-system-diagram.jpg %}){:style="width:50%;"}
...
{% include slides/background-image.html
id="empihardware"
image="lectures/genai/empi_open.jpg"
bgcol="#000000"
%}
...
{% include slides/background-image.html
id="empi2"
image="lectures/genai/empi_2.jpg"
%}


{% include slides/background-image.html
id="empiproofofconcept"
image="lectures/genai/empi_00.jpg"
%}

{% include slides/background-image.html
id="empi0"
image="lectures/genai/empi_0.jpg"
%}

{% include slides/background-image.html
id="empi1"
image="lectures/genai/empi_1.jpg"
%}

{% include slides/background-image.html
id="empicases"
image="lectures/genai/empi_designs.jpg"
%}
...
{% include slides/background-image.html
id="empi3"
image="lectures/genai/empi_3.jpg"
%}
...
![Human Data]({% link assets/lectures/genai/training_human.png %})
![Sine Data]({% link assets/lectures/genai/training_sine.png %}){:style="width:24%" }
![Square Data]({% link assets/lectures/genai/training_square.png %}){:style="width:24%" }
![Saw Data]({% link assets/lectures/genai/training_saw.png %}){:style="width:24%" }
![Noise Data]({% link assets/lectures/genai/training_noise.png %}){:style="width:24%" }

## Generated Data

![Human Generation]({% link assets/lectures/genai/generation_human_4500points.png %}){:style="width:50%" }
![Synth Generation]({% link assets/lectures/genai/generation_synth.png %}){:style="width:50%" }
![Noise Generation]({% link assets/lectures/genai/generation_noise.png %}){:style="width:50%" }


{% include slides/background-video.html
id="empihuman"
video="lectures/genai/empi-short-demo.mp4"
%}

{% include slides/background-video.html
id="empinoise"
video="lectures/genai/empi_synth.mp4"
%}

{% include slides/background-video.html
id="empinoise"
video="lectures/genai/empi_noise.mp4"
%}


{% include slides/background-image.html
id="empi-experiment"
image="lectures/genai/study-image.jpg"
...
![]({% link assets/lectures/genai/survey_boxplot_results.jpg %}){:style="width:80%;"}
...
![]({% link assets/lectures/genai/performance_length.jpg %}){:style="width:80%;"}
...
{% include slides/background-image.html
id="whattodo"
image="lectures/genai/ipad-ensemble-2015.jpg"
opacity="0.5"
bgcol="#000000"
...
{% include slides/background-image.html
id="evaluation"
image="lectures/genai/metatone-20170529-ifi.jpg"
opacity="0.4"
bgcol="#000000"
...
![]({% link assets/lectures/genai/charlesgif.gif %}){:style="width:25%;"} 
...
![]({% link assets/lectures/genai/predictive-interactions.png %}){:style="width:50%;float:right;"}
...
![]({% link assets/lectures/genai/colab.png %}){:style="float:right;width:40%;"}
