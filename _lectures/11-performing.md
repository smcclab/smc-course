...
What are the _ways of performing_ computer music.

Here's a list of different _modalities_ I have noticed over time.

## The Big Screen

these performers want the audience to see what they see and they want it to be _big_.
...
the instrument _is the performance_
...
no _table_ can hold our brilliance

these performances are all about getting maximum equipment and minimum complications


{% include slides/background-image.html image="lectures/setups/floor-2016-youarehere.jpg" heading="carpark concert, Michael Norris, You Are Here, Canberra, 2016" %}
{% include slides/background-image.html image="lectures/setups/floor-electrofringe.jpg" heading="noise, 107 projects, Sydney, 2015" %}
...
these performance want to be a _cyber person_; or maybe they **are** a cyber person!

VR, AR, XR, etc. reality is not enough for these folks!

their motto: maybe _this year_ is when VR will go mainstream!

_headgear_ also includes other head-mounted musical modalities...
...
hyperinstrumentalists have invested a lifetime of practice into their instrument _and they're not giving it up now_
...
they minimise the computer in their setup (_it's not about the computer_)
